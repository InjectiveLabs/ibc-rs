...
def packet_send(c: Config, src: ChainId, dst: ChainId,
                ...
                amount: int, denom: str, height_offset: int, number_msgs: Optional[int] = None,
...
def ping_pong(c: Config,
    ...
    pkt_send_a = packet_send(c, side_a, side_b, port_id,
                             a_chan, amount=9999, denom="inj", height_offset=1000)
    ...
    pkt_send_b = packet_send(c, side_b, side_a, port_id,
                             b_chan, amount=9999, denom="inj", height_offset=1000)
...
def timeout(c: Config,
    ...
    pkt_send_a = packet_send(c, side_a, side_b, port_id,
                             a_chan, amount=9999, denom="inj", height_offset=1)
    ...
    pkt_send_b = packet_send(c, side_b, side_a, port_id,
                             b_chan, amount=9999, denom="inj", height_offset=1)
